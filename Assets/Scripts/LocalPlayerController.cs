...
{
    public class LocalPlayerController : NetworkRegulatorSingleton<LocalPlayerController>
    {
        //[SerializeField] private Renderer fader;
        //[SerializeField] private Renderer[] hands;
        [SerializeField] private TrackedDevice TrackedDevicePrefab;

        public TrackedDevice TrackedDevice { get; private set; }

        public float HandGlowIntensity { get; private set; }
        public float HandGlowSpeed { get; private set; }
